      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">      
        ...
        <div className="bg-white shadow-lg rounded-lg overflow-hidden">
          ...
          <div className="h-96 bg-gray-200 relative">
            ...
            />
            <div className="absolute top-4 right-4 bg-white px-3 py-2 rounded-md text-lg font-semibold text-gray-800">
              ${destination.price}
            </div>
          </div>
          ...
          <div className="p-6 md:p-8">
            <div className="flex flex-col md:flex-row md:justify-between md:items-start mb-6">
              ...
              <div className="text-center md:text-right">
                <p className="text-3xl font-bold text-green-600">${destination.price}</p>
              ...
              {activeTab === 'overview' && (
                <div>
                  ...
                  <ul className="list-disc list-inside space-y-2 text-gray-700 mb-6">
                    ...
                    <li>Scenic boat ride</li>
                    <li>Visit to local markets</li>
                    <li>Free time for exploration</li>
                  </ul>
                </div>
              )}
                ...
                <div>
                  ...
                  <div className="space-y-4">
                    <div className="border-l-4 border-blue-400 pl-4">
                      ...
                      <p className="text-gray-700">Arrive at destination, check-in at hotel, and evening at leisure.</p>
                    </div>
                    <div className="border-l-4 border-blue-400 pl-4">
                      <h3 className="text-lg font-semibold">Day 2: City Tour</h3>
                      <p className="text-gray-700">Full day guided tour of the city's main attractions.</p>
                    </div>
                    <div className="border-l-4 border-blue-400 pl-4">
                      <h3 className="text-lg font-semibold">Day 3: Adventure Day</h3>
                      <p className="text-gray-700">Outdoor activities and adventure sports.</p>
                    </div>
                    <div className="border-l-4 border-blue-400 pl-4">
                      <h3 className="text-lg font-semibold">Day 4: Departure</h3>
                      <p className="text-gray-700">Morning at leisure, then transfer to airport for departure.</p>
                    </div>
                  </div>
                </div>
              )}
